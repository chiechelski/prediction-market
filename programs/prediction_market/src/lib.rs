...
pub mod prediction_market {
    ...
    pub fn initialize_config(
        ...
        initialize_config::handler(ctx, platform_fee_bps, platform_treasury)
    }
    ...
    pub fn update_config(
        ...
        update_config::handler(ctx, platform_fee_bps, platform_treasury)
    }
    ...
    pub fn mint_complete_set(ctx: Context<MintCompleteSet>, args: MintCompleteSetArgs) -> Result<()> {
        mint_complete_set::handler(ctx, args)
    }

    pub fn redeem_complete_set(ctx: Context<RedeemCompleteSet>, args: RedeemCompleteSetArgs) -> Result<()> {
        redeem_complete_set::handler(ctx, args)
    }

    pub fn close_market_early(ctx: Context<CloseMarketEarly>, args: CloseMarketEarlyArgs) -> Result<()> {
    ...
    pub fn finalize_resolution(ctx: Context<FinalizeResolution>, args: FinalizeResolutionArgs) -> Result<()> {
